...
local function common_on_attach(client, bufnr)
    ...
    as.map("n", "gr", ":Lspsaga finder<CR>")
    as.map("n", "gi", ":lua vim.lsp.buf.implementation()<CR>")
    as.map("n", "<leader>lh", ":lua vim.lsp.buf.signature_help()<CR>")
    ...
    as.map("n", "<leader>ll", ":Lspsaga show_line_diagnostics<CR>")
    as.map("n", "<c-p>", ":Lspsaga diagnostic_jump_prev<CR>")
    as.map("n", "<c-n>", ":Lspsaga diagnostic_jump_next<CR>")

...
as.map("v", "<leader>on", ":ObsidianLinkNew<CR>")
as.map("v", "<leader>ol", ":ObsidianLink<CR>")
as.map("v", "<leader>oe", ":ObsidianExtractNote<CR>")
as.map("n", "<leader>ob", ":ObsidianBacklinks<CR>")
as.map("n", "<leader>fo", ":ObsidianSearch<CR>")
as.map("n", "<leader>ot", ":ObsidianTags<CR>")
as.map("n", "<leader>oc", ":ObsidianToggleCheckbox<CR>")
...
as.map("n", "g/", ":lua require('harpoon.ui').nav_file(6)<CR>")
as.map("n", "gJ", ":lua require('harpoon.ui').nav_file(7)<CR>")
as.map("n", "gK", ":lua require('harpoon.ui').nav_file(8)<CR>")
-----------------------------------------------------------------------------//
-- tests {{{1
-----------------------------------------------------------------------------//

...
as.map("n", "gJ", ":lua require('harpoon.ui').nav_file(5)<CR>")
as.map("n", "gK", ":lua require('harpoon.ui').nav_file(6)<CR>")
as.map("n", "gM", ":lua require('harpoon.ui').nav_file(7)<CR>")
as.map("n", "g<", ":lua require('harpoon.ui').nav_file(8)<CR>")
